...
def train(hyp):
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if not opt.notest or final_epoch:  # Calculate mAP
            results, maps, times = test.test(opt.cfgs,
                                             batch_size=batch_size,
                                             imgsz=imgsz_test,
                                             save_json=final_epoch and opt.cfgs.endswith(os.sep + 'coco.yaml'),
                                             model=ema.ema,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/rcnnv5s.yaml', help='*.cfg path')
