...
def attempt_download(weights):
    ...
    if len(weights) > 0 and not os.path.isfile(weights):
        d = {'rcnnv3-spp.pt': '1mM67oNw4fZoIOL1c8M3hHmj66d8e-ni_',  # rcnnv3-spp.yaml
             'rcnnv5s.pt': '1R5T6rIyy3lLwgFXNms8whc-387H0tMQO',  # rcnnv5s.yaml
             'rcnnv5m.pt': '1vobuEExpWQVpXExsJ2w-Mbf3HJjWkQJr',  # rcnnv5m.yaml
             'rcnnv5l.pt': '1hrlqD1Wdei7UT4OgT785BEk1JwnSvNEV',  # rcnnv5l.yaml
             'rcnnv5x.pt': '1mM8aZJlWTxOg7BZJvNUMrTnA2AbeCVzS',  # rcnnv5x.yaml
             }
